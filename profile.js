...
refreshBtn.addEventListener("click", () => { loadProfile().catch(()=>{}); });
...
async function loadProfile(){
  ...
  try {
    ...
    // audit-safe: ignore null/undefined grades
    ...
    // ✅ Extra section + extra graph: XP by path
    ...
    // Extra graph (top 6) – shorten labels by using last path segment
...
function shortPath(p){
  // Keeps it readable: show last 2 segments
